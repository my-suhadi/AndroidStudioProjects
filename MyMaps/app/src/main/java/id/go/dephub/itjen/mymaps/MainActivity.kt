// https://www.youtube.com/playlist?list=PL7NYbSE8uaBCSkZum6Z88RvjiXrTBpjT2
...
import id.go.dephub.itjen.mymaps.models.Place
...
class MainActivity : AppCompatActivity() {
    ...
    private var userMaps = emptyList<UserMap>().toMutableList()
    ...
    private fun deserializeUserMaps(context: Context): List<UserMap> {
        ...
        if (!dataFile.exists()){
            ...
            return generateSampleData().toMutableList()
            // return emptyList()
        }
